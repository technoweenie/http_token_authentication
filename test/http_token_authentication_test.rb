require 'test/unit'
require 'http_token_authentication'
require 'rubygems'
...
class HttpTokenAuthenticationTest < ActionController::TestCase
  class DummyController < ActionController::Base
    include HttpTokenAuthentication::ControllerMethods
  ...
  setup do
    ...
    ActionController::Routing.module_eval { const_set :Routes, ActionController::Routing::RouteSet.new }
  ...
  def encode_credentials(token, options = {})
    HttpTokenAuthentication.encode_credentials(token, options)
  end
end
